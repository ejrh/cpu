...
class VarCheckTests(unittest.TestCase):
    ...
    def testEmptyFunc(self):
        ...
        self.assertTrue(func.cfg.has_connection(func.cfg.entry, func.cfg.exit))
    
    def testSingleStatement(self):
        func = FunctionDecl(int_type, 'f', [], Block([Statement(None)]))
        self.assertSuccess(func)
        stmt_node, = func.cfg.entry.out_edges.keys()
        self.assertTrue(func.cfg.has_connection(func.cfg.entry, stmt_node))
        self.assertTrue(func.cfg.has_connection(stmt_node, func.cfg.exit))
    ...
    def testTwoStatements(self):
        ...
        self.assertTrue(func.cfg.has_connection(func.cfg.entry, stmt_node1))
        self.assertTrue(func.cfg.has_connection(stmt_node1, stmt_node2))
        self.assertTrue(func.cfg.has_connection(stmt_node2, func.cfg.exit))
